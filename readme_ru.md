Задание: есть сервис petstore, он поднят тут https://petstore.swagger.io/v2 У него есть спецификация OAS3 файлик petstory.yaml - это единственное что у тебя есть из входных параметров.
